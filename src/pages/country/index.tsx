                  ...
                  <Row className="my-5">
                    <Col lg={6}>
                      ...
                      <iframe
                        ...
                        src={`https://maps.google.com/maps?q=${country.name}&z=5&t=m&output=embed`}
                      />
                    </Col>
                    <Col lg={6}>
                      ...
                      <Row>
                        <p>
                          This country also called as{" "}
                          <span title="German">
                            {country.translations.de} in German,{" "}
                          </span>
                          <span title="Spanish">
                            {country.translations.es} in Spanish,{" "}
                          </span>
                          <span title="French">
                            {country.translations.fr} in French,{" "}
                          </span>
                          <span title="Japanese">
                            {country.translations.ja} in Japanese,{" "}
                          </span>
                          <span title="Italian">
                            {country.translations.it} in Italian,{" "}
                          </span>
                          <span title="Persian">
                            {country.translations.fa} in Persian,{" "}
                          </span>
                          <span title="Portuguese">
                            {country.translations.pt} in Portuguese,{" "}
                          </span>
                          <span title="Dutch">
                            {country.translations.nl} in Dutch.
                          </span>
                        </p>
                      </Row>
                      <hr />
                      <Row className="w-100">
                        <div className="card-columns">
                          <Card className="p-2 bg-dark text-white  align-items-center justify-content-between">
                            <h1 className="card-title h4 text-center">
                              {country.capital}
                            </h1>
